...
const plans: Plan[] = [
  {
    ...
    features: [
      ...
      { text: '6 áreas de desenvolvimento', included: true },
      { text: 'Portal educativo completo', included: true },
      { text: 'Questionário de estilo de aprendizagem', included: false },
      { text: 'Histórico de atividades', included: false },
      { text: 'Progresso do filho', included: false },
    ],
    cta: 'Começar grátis',
  ...
  },
  {
    ...
    features: [
      ...
      { text: '1 perfil de filho', included: true },
      { text: '6 áreas de desenvolvimento', included: true },
      { text: 'Questionário de estilo de aprendizagem', included: true },
      { text: 'Relatório personalizado pela IA', included: true },
      { text: 'Histórico completo de atividades', included: true },
      { text: 'Acompanhamento de progresso', included: true },
      { text: 'Orientações para escola', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Geração de atividades por IA', included: true },
      { text: 'Notas por competência', included: true },
      { text: 'Relatórios de progresso', included: true },
      { text: 'Metas por bimestre', included: true },
